...
static void* rtvk_output_user_data = NULL;
...
enum rt_error rtvk_error_from_vk(VkResult result) {
	...
	case VK_ERROR_OUT_OF_DEVICE_MEMORY: return RT_OUT_OF_DEVICE_MEMORY;
	case VK_ERROR_INITIALIZATION_FAILED: return RT_INITIALIZATION_FAILED;
	case VK_ERROR_LAYER_NOT_PRESENT: return RT_LAYER_NOT_PRESENT;
	case VK_ERROR_EXTENSION_NOT_PRESENT: return RT_EXTENSION_NOT_PRESENT;
	case VK_ERROR_INCOMPATIBLE_DRIVER: return RT_INCOMPATIBLE_DRIVER;
