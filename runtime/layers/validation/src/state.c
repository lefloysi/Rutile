...
PFN_rtCommandBufferCreate rtval_next_rtCommandBufferCreate = NULL;
...
RT_EXPORT void rtLayerSetNext(rt_proc_chain next) {
	...
	rtval_next_rtCommandBufferCreate = (PFN_rtCommandBufferCreate)next.get_proc(&next, "rtCommandBufferCreate");
