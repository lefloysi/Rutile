...
RTDX_API rt_texture_view rtTextureViewCreate(void);
...
RTDX_API rt_timepoint rtTextureData(rt_texture texture, enum rt_texture_type type, u32 mip, u32 width, u32 height, u32 depth, enum rt_format format, const void* data);
