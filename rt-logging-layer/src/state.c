...
PFN_rtBufferMap next_rtBufferMap = NULL;
PFN_rtBufferUnmap next_rtBufferUnmap = NULL;
...
PFN_rtGraphicsProgramVertexLayout next_rtGraphicsProgramVertexLayout = NULL;
PFN_rtGraphicsProgramVertexShader next_rtGraphicsProgramVertexShader = NULL;
PFN_rtGraphicsProgramFragmentShader next_rtGraphicsProgramFragmentShader = NULL;
...
PFN_rtCmdCreate next_rtCmdCreate = NULL;
PFN_rtCmdDestroy next_rtCmdDestroy = NULL;
...
RT_EXPORT void rtLayerSetNext(rt_proc_chain next) {
	...
	next_rtBufferMap = (PFN_rtBufferMap)next.get_proc(&next, "rtBufferMap");
	next_rtBufferUnmap = (PFN_rtBufferUnmap)next.get_proc(&next, "rtBufferUnmap");
	...
	next_rtGraphicsProgramVertexLayout = (PFN_rtGraphicsProgramVertexLayout)next.get_proc(&next, "rtGraphicsProgramVertexLayout");
	next_rtGraphicsProgramVertexShader = (PFN_rtGraphicsProgramVertexShader)next.get_proc(&next, "rtGraphicsProgramVertexShader");
	next_rtGraphicsProgramFragmentShader = (PFN_rtGraphicsProgramFragmentShader)next.get_proc(&next, "rtGraphicsProgramFragmentShader");
	...
	next_rtCmdCreate = (PFN_rtCmdCreate)next.get_proc(&next, "rtCmdCreate");
	next_rtCmdDestroy = (PFN_rtCmdDestroy)next.get_proc(&next, "rtCmdDestroy");
